...
function PlanCard({
  ...
  return (
    <div className="border-2 border-gray-c2 p-4 rounded-none text-white flex flex-col">
      ...
      <p className="text-sm mt-2 flex-grow">{plan.description}</p>
      ...
      {/* It now uses the Next.js <Link> component for client-side routing */}
      {/* and points to the /subscription page with the correct planId query parameter. */}
      <Link
